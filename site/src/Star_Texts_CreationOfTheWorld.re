    ...
    words: [
      ...
      Word.make(
        ...
        ~attributes=[
          ({j|gender|j}, {j|divine|j}),
          ({j|case|j}, {j|prepositional|j}),
          ({j|number|j}, {j|plural|j}),
        ],
        (),
      ),
      Word.make(
        ~orthography={j|áŕksikr|j},
        ~broad={j|ˈaːʕ.kʰsi.kʰɹ|j},
        ~narrow={j|ˈäːʕ.kʰsɨ.kʰɹ|j},
        ~literal={j|ordinal|j},
        ~attributes=[
          ({j|gender|j}, {j|divine|j}),
          ({j|case|j}, {j|prepositional|j}),
      ...
      Word.make(
        ~orthography={j|gatrfr|j},
        ~broad={j|ˈkʼa.tʰɹ.ɸɹ|j},
        ~narrow={j|ˈqʼɑ.tʰɹ.ɸɹ|j},
        ~literal={j|years|j},
        ~attributes=[
          ({j|gender|j}, {j|divine|j}),
          ({j|case|j}, {j|prepositional|j}),
      ...
      Word.make(
        ~orthography={j|yetéksikr|j},
        ~broad={j|ˈje.tʰeː.kʰsi.kʰɹ|j},
        ~narrow={j|ˈje̞.tʰəː.kʰsɨ.kʰɹ|j},
        ~literal={j|ago|j},
        ~attributes=[
          ({j|gender|j}, {j|divine|j}),
          ({j|case|j}, {j|prepositional|j}),
